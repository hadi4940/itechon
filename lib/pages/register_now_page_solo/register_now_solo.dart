...
class RegisterNowPageSolo extends StatefulWidget {
  static const String route = '/registerSolo';
  const RegisterNowPageSolo({super.key});

  @override
  State<RegisterNowPageSolo> createState() => _RegisterNowPageState();
}

class _RegisterNowPageState extends State<RegisterNowPageSolo> {
  //Image? image1;
  Uint8List? image1;
          ...
          ResponsiveGridRow(
            children: [
              ...
              ResponsiveGridCol(
                ...
                sm: 12,
                child: ListTile(
                  title: const Text('Solo Registration'),
                  leading: Radio(
                    value: 1,
